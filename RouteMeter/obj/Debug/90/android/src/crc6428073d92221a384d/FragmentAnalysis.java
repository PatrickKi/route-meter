package crc6428073d92221a384d;


public class FragmentAnalysis
	extends crc6428073d92221a384d.FragmentBase
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("RouteMeter.Fragments.FragmentAnalysis, RouteMeter", FragmentAnalysis.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == FragmentAnalysis.class)
			mono.android.TypeManager.Activate ("RouteMeter.Fragments.FragmentAnalysis, RouteMeter", "", this, new java.lang.Object[] {  });
	}
